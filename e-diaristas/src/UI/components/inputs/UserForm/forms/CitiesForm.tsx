import useCitiesForm from "data/hook/components/inputs/UserForm/forms/useCitiesForm";
          ...
          return (
            <TextField 
              ...
              InputProps={{
                ...
                endAdornment:(
                  <>
                    {citiesList.length ? <i className="twf-search"/> : <CircularProgress />}
