import useAddressForm from "data/hook/components/inputs/UserForm/forms/useAddressForm"
...
export const AddressForm = () => {
  const { control, errors, estados, opcoesCidades, addressState, register, userAddress } =
    useAddressForm();
